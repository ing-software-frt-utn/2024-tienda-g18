        ...
        public async Task<Venta> Registrar(Venta entidad)
        {
            ...
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    string numeroComprobante = ceros + correlativo.UltimoNumero.ToString();
                    numeroComprobante = numeroComprobante.Substring(numeroComprobante.Length - correlativo.CantidadDigitos.Value, correlativo.CantidadDigitos.Value);

                    entidad.NumeroComprobante = numeroComprobante;
