USE [master]
GO
/****** Object:  Database [DBTIENDA]    Script Date: 15/03/2024 16:22:47 ******/
CREATE DATABASE [DBTIENDA]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DBTIENDA', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\DBTIENDA.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
...
USE [DBTIENDA]
GO
/****** Object:  Table [dbo].[AFIP]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AFIP](
	[idAFIP] [int] IDENTITY(1,1) NOT NULL,
	[token] [varchar](1000) NULL,
	[cae] [varchar](1000) NULL,
	[vencimientoToken] [datetime2](7) NULL,
 CONSTRAINT [PK__AFIP__EC87626F6D9F50E7] PRIMARY KEY CLUSTERED 
(
	[idAFIP] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Articulo]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Articulo](
	...
	[margenGanancia] [decimal](10, 2) NULL,
...
GO
/****** Object:  Table [dbo].[Categoria]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cliente]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Color]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CondicionTributaria]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Configuracion]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DetalleVenta]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[DetalleVenta](
	...
	[cantidad] [int] NULL,
	[netoGravado] [decimal](10, 2) NULL,
	[iva] [decimal](10, 2) NULL,
	[total] [decimal](10, 2) NULL,
	[nombreArticulo] [varchar](50) NULL,
	[margenGanancia] [decimal](10, 2) NULL,
	[colorInventario] [varchar](50) NULL,
	[talleInventario] [varchar](50) NULL,
PRIMARY KEY CLUSTERED 
(
	[idDetalleVenta] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[Empleado]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inventario]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Marca]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Menu]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NumeroCorrelativo]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Pago]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PuntoVenta]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Rol]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RolMenu]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sesion]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Sucursal]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Talle]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Tarjeta]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tarjeta](
	...
	[mesTarjeta] [varchar](50) NULL,
	[codigoSeguridadTarjeta] [varchar](50) NULL,
	[nombreTarjeta] [varchar](50) NULL,
	[anioTarjeta] [varchar](50) NULL,
 CONSTRAINT [PK__Tarjeta__C456D53871DCA104] PRIMARY KEY CLUSTERED 
(
	[idTarjeta] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[TipoComprobante]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoPago]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TipoTalle]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Venta]    Script Date: 15/03/2024 16:22:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Venta](
	...
	[numeroComprobante] [varchar](6) NULL,
	[idTipoComprobante] [int] NULL,
	[idUsuario] [int] NULL,
	[idCliente] [int] NULL,
	[idPago] [int] NULL,
...
GO
ALTER TABLE [dbo].[CondicionTributaria]  WITH CHECK ADD  CONSTRAINT [FK_CondicionTributaria_idTipoComprobante] FOREIGN KEY([idCondicionTributaria])
REFERENCES [dbo].[CondicionTributaria] ([idCondicionTributaria])
GO
ALTER TABLE [dbo].[CondicionTributaria] CHECK CONSTRAINT [FK_CondicionTributaria_idTipoComprobante]
GO
...
GO
ALTER TABLE [dbo].[Pago]  WITH CHECK ADD  CONSTRAINT [FK__Pago__idTarjeta__756D6ECB] FOREIGN KEY([idTarjeta])
REFERENCES [dbo].[Tarjeta] ([idTarjeta])
GO
ALTER TABLE [dbo].[Pago] CHECK CONSTRAINT [FK__Pago__idTarjeta__756D6ECB]
GO
ALTER TABLE [dbo].[Pago]  WITH CHECK ADD  CONSTRAINT [FK_Pago_idTipoPago] FOREIGN KEY([idPago])
REFERENCES [dbo].[Pago] ([idPago])
GO
ALTER TABLE [dbo].[Pago] CHECK CONSTRAINT [FK_Pago_idTipoPago]
GO
...
REFERENCES [dbo].[Usuario] ([idUsuario])
GO
ALTER TABLE [dbo].[Sucursal]  WITH CHECK ADD  CONSTRAINT [FK_Sucursal_CondicionTributaria] FOREIGN KEY([idCondicionTributaria])
REFERENCES [dbo].[CondicionTributaria] ([idCondicionTributaria])
GO
ALTER TABLE [dbo].[Sucursal] CHECK CONSTRAINT [FK_Sucursal_CondicionTributaria]
GO
